...
module.exports = {
    ...
    run : async(client, message) => {
        if(message.channel.parentID !== '870183646605234196') return message.channel.send('You can only use this command in a ticket!');
        const transcriptChannel = message.guild.channels.cache.get('870183646605234196')
